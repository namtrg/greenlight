...
module Greenlight
  class Application < Rails::Application
    ...
    config.branding_image_default = "https://raw.githubusercontent.com/namtrg/greenlight/master/app/assets/images/bbb_logo.png"

    # Default primary color if the user does not specify one
    config.primary_color_default = "#0069ff"
    ...
    config.primary_color_darken_default = "#0055cf"
